...
// const reversed = String(original);

// console.log(reversed);

// 3 - masala

// let arr1 = 'java25scrip12tdiyorbek5369';
...
//     return numbers.filter(num => num > 0).redu((acc, num) => acc + num, 0);
// }
// let number = [1, -5, 2, 3, -7];
